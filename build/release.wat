(module
 ...
 (func $assembly/index/test_sha256
  ...
  local.get $0
  local.set $1
  block $__inlined_func$~lib/string/String.UTF8.encodeUnsafe$7
   loop $while-continue|00
    ...
    if
     ...
     if
      ...
      local.get $3
      i32.eqz
      br_if $__inlined_func$~lib/string/String.UTF8.encodeUnsafe$7
     else
      local.get $3
      i32.const 2048
      i32.lt_u
